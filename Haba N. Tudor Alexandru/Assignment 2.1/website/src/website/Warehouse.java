...
public class Warehouse {
	...
	public Warehouse() {
		...
		productList.add(jacket.getName());
		productList.add(hat.getName());
		productList.add(scarf.getName());
		productList.add(shoes.getName());
		productList.add(gloves.getName());
		productList.add(boots.getName());
		productList.add(socks.getName());
		productList.add(television.getName());
		productList.add(laptop.getName());
		productList.add(monitor.getName());
		productList.add(television.getName());
		productList.add(keyboard.getName());
		productList.add(mouse.getName());
	}
