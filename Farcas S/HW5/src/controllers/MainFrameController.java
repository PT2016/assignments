...
public class MainFrameController {
	...
	public class AddButtonActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (frame.getTable1() == null)
				frame.constructTable1(Dictionary.getInstance().search(frame.getSearch().getText()));
			try {
				Dictionary.getInstance().add(new Word(w, false), false);
					...
					if (choice == 0) {
						...
						try {
							Dictionary.getInstance()
									.define(new Word((String) frame.getTable1().getValueAt(index, 0), false), p, false);
		...
		public void actionPerformed(ActionEvent e) {
			if (frame.getTable1() != null) {
				...
				if (index != -1)
					try {
						Dictionary.getInstance()
								.removeKey(new Word((String) frame.getTable1().getValueAt(index, 0), false), false);
	...
	public class PopulateButtonActionListener implements ActionListener {
		@Override
		public void actionPerformed(ActionEvent e) {
			new PopulateController(new PopulateFrame("Populate"));
		}
	}
