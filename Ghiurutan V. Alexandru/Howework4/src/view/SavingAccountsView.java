...
public class SavingAccountsView extends JFrame implements ActionListener {
	...
	public SavingAccountsView(Person person, ArrayList<Object> accounts) {
	...
	private void updateTable() {
		table = createGeneralTable(bank.getPersonSavingAccounts(person));
	}
